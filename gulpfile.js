...
var STATE_MACHINE_PATH = './node_modules/javascript-state-machine/dist/';
...
function serve() {
	...
	*/
    ...
    return gulp.src('')
    .pipe(exec('phonegap serve', options))
...
gulp.task('watch-html', ['buildHtml']);
gulp.task('watch-js', ['fastBuild']);
gulp.task('watch-static', ['copyLibs']);
